...
namespace Lector_Laser
{
    public class CommandLib
    {
        ...
        [DllImport("MEDAQlib.dll")]
        public static extern ERR_CODE EnableLogging(UInt32 instanceHandle, Int32 enableLogging, Int32 logType, Int32 logLevel, String logFile, Int32 logAppend, Int32 logFlush, Int32 logSplitSize);
        [DllImport("MEDAQlib.dll")]
